...
if (isPackaged) {
  ...
  // log.transports.file.fileName = path.join(dataDir, "logs", "electron.log");
}

// Get correct Python executable path based on platform
...
const scriptPath = isPackaged
  ...
  : path.join(rootDir, "src-py", "controller.py");
...
function main() {
  ...
  // Update your PythonShell initialization
  const pyShell = new PythonShell(scriptPath, {
    cwd: isPackaged ? path.join(process.resourcesPath, "src-py") : rootDir,
    mode: "json",
  ...
  console.log("Python shell initialized");
  console.log("Python path:", getPythonExecutable());
